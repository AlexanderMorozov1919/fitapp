...
final List<AppNotification> mockNotifications = [
  ...
  AppNotification(
    ...
    timestamp: DateTime(2025, 9, 20, 14, 30),
    isRead: false,
  ),

  // Уведомления на 21 сентября
  AppNotification(
    id: 'notif_007',
    title: 'Изменение расписания',
    message: 'Занятие по йоге для продвинутых перенесено на 11:00',
    type: NotificationType.info,
    timestamp: DateTime(2025, 9, 21, 8, 45),
    isRead: false,
    relatedId: 'class_011',
  ),
  AppNotification(
    ...
    type: NotificationType.reminder,
    timestamp: DateTime(2025, 9, 21, 18, 0),
    isRead: false,
    relatedId: 'locker_004',
  ),

  // Уведомления на 22 сентября
  AppNotification(
    id: 'notif_009',
    title: 'Новый тренер',
  ...
  AppNotification(
    ...
    type: NotificationType.payment,
    timestamp: DateTime(2025, 9, 22, 16, 20),
    isRead: false,
  ...
  AppNotification(
    ...
    type: NotificationType.info,
    timestamp: DateTime(2025, 9, 23, 7, 15),
    isRead: false,
    relatedId: 'class_015',
  ),
  AppNotification(
    ...
    type: NotificationType.promo,
    timestamp: DateTime(2025, 9, 23, 9, 0),
    isRead: false,
  ),
  ...
  AppNotification(
    ...
    type: NotificationType.reminder,
    timestamp: DateTime(2025, 9, 24, 16, 0),
    isRead: false,
  ...
  AppNotification(
    ...
    timestamp: DateTime(2025, 9, 24, 11, 30),
    isRead: false,
  ),
  ...
  AppNotification(
    ...
    type: NotificationType.reminder,
    timestamp: DateTime(2025, 9, 25, 10, 0),
    isRead: false,
    relatedId: 'class_020',
  ),
  AppNotification(
    ...
    type: NotificationType.info,
    timestamp: DateTime(2025, 9, 25, 14, 0),
    isRead: false,
    relatedId: 'mem_001',
  ),
];