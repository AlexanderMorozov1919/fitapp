...
class TennisTimeSelectionScreen extends StatefulWidget {
  ...
  const TennisTimeSelectionScreen({super.key, required this.selectedCourt});

  @override
  State<TennisTimeSelectionScreen> createState() => _TennisTimeSelectionScreenState();
}

class _TennisTimeSelectionScreenState extends State<TennisTimeSelectionScreen> {
