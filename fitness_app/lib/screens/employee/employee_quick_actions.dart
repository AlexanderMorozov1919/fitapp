...
class EmployeeQuickActions extends StatefulWidget {
  final Function(String, [dynamic]) onQuickAccessNavigate;

  const EmployeeQuickActions({super.key, required this.onQuickAccessNavigate});

  @override
  State<EmployeeQuickActions> createState() => _EmployeeQuickActionsState();
}

class _EmployeeQuickActionsState extends State<EmployeeQuickActions>
